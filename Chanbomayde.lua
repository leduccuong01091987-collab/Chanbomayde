...
local WEBHOOKS = {
    FullMoon          = "https://discord.com/api/webhooks/1493455668189986830/HiEWILqosScoCCZObVOgirPm7efEcmL_uKJCzLrDzoM3x50LuaLZaRRqOnZIWnvpssi6",
    NearFullMoon      = "https://discord.com/api/webhooks/1489972504176099548/Ax0SiWkikITemgrt21lIYbAfvVEp98n0DOxbiqSibPvsZiApiiAscrWT9ZTL5oXaxjjF",
    Boss              = "https://discord.com/api/webhooks/1489972397867012146/KgWF45FYWCl_Ymij8tSvbVgWO-3z1Sppd53BbXRUUiNgXYB_paP-0CBFMO4IbTC4WWuW",
    Haki              = "https://discord.com/api/webhooks/1489973503254855814/A617qsd9cKAvZQ6NU5X3ARo5g0DUNw74ZKot2Stp_EsJH5ESPh3jkEP_uXQxZoLAfToe",
    Sword             = "https://discord.com/api/webhooks/1489973638613696706/j6-LxX8XqxDhOAbzjUk8b-1kov1e6yJ6EATqIdC3VgFxVYqMQn4vp03e93wZ9-Km9vwj",
    Fruit             = "https://discord.com/api/webhooks/1489973826115600434/lzjBgkBJf_v1eN8WQffPCuiB21HUAj9Dhl78_PKgO209xobvZ3Y0Jhevn6PmMEza4Tfi",
    KitsuneIsland     = "https://discord.com/api/webhooks/1489973949025489027/XfVkV0NOmFUyWJKPTn73QX78K6uJpwLmN70Fg3x6jzDfX8HZdOSUUuvv43mIfy9RMf4N",
    PrehistoricIsland = "https://discord.com/api/webhooks/1489972397867012146/KgWF45FYWCl_Ymij8tSvbVgWO-3z1Sppd53BbXRUUiNgXYB_paP-0CBFMO4IbTC4WWuW", 
    MirageIsland      = "https://discord.com/api/webhooks/1489974271991218176/IUd9ZrDhXJvO2VNZkvejqBQQGJuTNf5gTIZ_kWo4w7ViLf6FUALJemTs95Ot7LO_IhCp",
    Berry             = "https://discord.com/api/webhooks/1489973826115600434/lzjBgkBJf_v1eN8WQffPCuiB21HUAj9Dhl78_PKgO209xobvZ3Y0Jhevn6PmMEza4Tfi",
    Elites            = "https://discord.com/api/webhooks/1489972397867012146/KgWF45FYWCl_Ymij8tSvbVgWO-3z1Sppd53BbXRUUiNgXYB_paP-0CBFMO4IbTC4WWuW", 
    CastleRaid        = "https://discord.com/api/webhooks/1489972397867012146/KgWF45FYWCl_Ymij8tSvbVgWO-3z1Sppd53BbXRUUiNgXYB_paP-0CBFMO4IbTC4WWuW", 
}

local SHARED_IMAGE = "https://media.discordapp.net/attachments/1493240551212978370/1493971364623814738/Your_Name_Notify.png?ex=69e19181&is=69e04001&hm=109c0b7dc4aca08d2b9919a74b88a4743987099dab9ca0db968ec588e0cc1d92&=&format=webp&quality=lossless&width=1502&height=856"

local THUMBNAIL_IMAGE = "https://media.discordapp.net/attachments/1493240551212978370/1493970653156737154/square_image.png?ex=69e190d8&is=69e03f58&hm=0b145031a4cd0c86ec744328b9524e4bf9ce6f82cbdaad1491599b8f61846db8&=&format=webp&quality=lossless"
local WEBHOOK_ICONS = {
...
do
    local _w = worldMap[game.PlaceId]
    if _w == "World1" then World1 = true
    elseif _w == "World2" then World2 = true
    elseif _w == "World3" then World3 = true
    end
end
...
local function GetWebhookKey(eventType, dataKey)
    ...
    elseif eventType == "elite" or eventType == "elites" then return "Elites"
...
local function SendNotify(eventType, data)
    ...
    local maxPlayers  = CFG.Another.MaxPlayersInServer or 12 
    ...
    elseif eventType == "elite" or eventType == "elites" then
        fields = {
            {name = "⚔️ Elite Event :", value = "```" .. (data.name or "Elite Spawn") .. "```", inline = true},
            {name = "Players :",        value = "```" .. playerCount .. "/" .. maxPlayers .. "```", inline = true},
            {name = "Job-Id :",         value = "```" .. jobId .. "```", inline = false},
            {name = "Place-Id :",       value = "```" .. placeId .. "```", inline = false},
            {name = "Script :",         value = '```\ngame:GetService("ReplicatedStorage").__ServerBrowser:InvokeServer("teleport", "' .. jobId .. '")\n```', inline = false},
    ...
    local embed = {
        title     = "🚀 NOTIFY VIP BY YOUR NAME 🚀",
        author = {
            name     = "Your Name",
            icon_url = "https://media.discordapp.net/attachments/1493240551212978370/1493970653156737154/square_image.png?ex=69e190d8&is=69e03f58&hm=0b145031a4cd0c86ec744328b9524e4bf9ce6f82cbdaad1491599b8f61846db8&=&format=webp&quality=lossless",
        },
        color     = color,
        fields    = fields,
...
-- [FIXED] Removed duplicate world detection (already handled at top)

task.spawn(function()
    task.wait(6)
    pcall(function()
        if CFG.Another.AutoRandomFruitOnJoin then
...
local tween = nil  -- tween dùng để bay đến target
    ...
    pcall(function()
        if lp.Character and lp.Character:FindFirstChild("HumanoidRootPart") and lp.Character:FindFirstChild("Humanoid") and lp.Character.Humanoid.Health > 0 then
            ...
            if Distance <= 250 then
                -- Teleport trực tiếp rồi return, không tạo tween
                if tween then pcall(function() tween:Cancel() end) end
            ...
            -- Chỉ tạo tween mới nếu chưa có tween đang chạy đến gần đúng vị trí đó
            pcall(function()
                local shouldRetween = true
                if tween and tween.PlaybackState == Enum.PlaybackState.Playing then
                    local hrp = game.Players.LocalPlayer.Character.HumanoidRootPart
                    local remainDist = (Pos.Position - hrp.Position).Magnitude
                    -- Nếu tween hiện tại đang bay đến đúng hướng và còn gần đích thì giữ nguyên
                    if remainDist < 150 then
                        shouldRetween = false
                    end
                end
                if shouldRetween then
        ...
        if y and typeof(y) == "table" then
            pcall(function()
                if y.activeController then
                    ...
                    if CFG.Another.AutoAttack and getgenv().targ and getgenv().targ.Character and 
                       ...
                       lp.Character.Humanoid.Health > 0 then
                    ...
                    y.activeController.attacking = shouldAttack
...
task.spawn(function()
    while task.wait(0.03) do
        pcall(function()
            if not CFG.Another.AutoAttack then return end
            ...
            if getgenv().targ and getgenv().targ.Character and getgenv().targ.Character:FindFirstChild("HumanoidRootPart") then
                local targetRoot = getgenv().targ.Character.HumanoidRootPart
                local distance = (targetRoot.Position - root.Position).Magnitude
                if distance < 40 then
                    local vec = targetRoot.Position - root.Position
                    local dir = vec.Magnitude == 0 and Vector3.zero or vec.Unit
...
HopServers = function(counts)
    DontHop = false
    pcall(function()
        local maxPlayers = counts or getgenv().Setting.Another.MaxPlayersInServer or 10 
...
local _distanceOverCount = 0  -- đếm số lần vượt MaxDistance liên tiếp trước khi skip
SkipPlayer = function()
    if _skipDebounce then return end
    _skipDebounce = true
    task.delay(0.5, function() _skipDebounce = false end)
    _distanceOverCount = 0  -- reset bộ đếm khi skip
...
function target()
    pcall(function()
        ...
        local maxTargetDistance = tonumber(CFG.Hunt.MaxDistance) or 30000
        local d = math.huge
        local p = nil
        getgenv().targ = nil
        for _, v in pairs(game.Players:GetPlayers()) do
            ...
            if v.Team ~= nil and (tostring(lp.Team) == "Pirates" or (tostring(v.Team) == "Pirates" and tostring(lp.Team) ~= "Pirates")) then
                if v and v:FindFirstChild("Data") and ((CFG.Skip.Fruit and hasValue(CFG.Skip.FruitList, v.Data.DevilFruit.Value) == false) or not CFG.Skip.Fruit) then
                    ...
                    if CFG.Skip.NoPvP and targetPvpDisabled then
                    elseif v ~= lp and v ~= getgenv().targ and
                       ...
                       not CheckSafeZone(v.Character.HumanoidRootPart) then

                        if (tonumber(lp.Data.Level.Value) - 250) < v.Data.Level.Value then
                            if v.leaderstats["Bounty/Honor"] and
                               v.leaderstats["Bounty/Honor"].Value >= CFG.Hunt.Min and
                               v.leaderstats["Bounty/Honor"].Value <= CFG.Hunt.Max then

                                if (CFG["Skip Race V4"] and not v.Character:FindFirstChild("RaceTransformed")) or not CFG["Skip Race V4"] then
                                    p = v
...
local gunmethod = CFG.Gun.GunMode
...
-- =============================================
-- Auto V3 thông minh theo tộc
-- Tộc thường (Cyborg/Fishman=Shark/Human/Mink/Skypiea/Dragon): bật ngay khi PVP bắt đầu
-- Tộc Ghoul (Quỷ): bật sau khi dùng hết 1 lượt skill melee+sword+fruit
-- =============================================
local _v3CooldownActive = false
local _ghoulSkillRoundCount = 0
local _ghoulSkillRoundTarget = 6  -- ~1 lượt đầy: Melee Z+X+C, Sword Z+X, Fruit Z+X+C = 8; lấy 6 để bật sớm

local _v3InstantRaces = {
    Cyborg = true,
    Fishman = true,  -- Shark = Fishman trong data
    Human = true,
    Mink = true,
    Skypiea = true,  -- Angel = Skypiea trong data
    Dragon = true,
    Draco = true,
}
...
local function GetPlayerRace()
    local ok, race = pcall(function()
        return tostring(lp.Data.Race.Value)
    end)
    return ok and race or ""
end

local function IsV3AlreadyActive()
    local char = lp.Character
...
local function FireActivateV3()
    if _v3CooldownActive then return end
    _v3CooldownActive = true
    pcall(function()
        game:GetService("ReplicatedStorage").Remotes.CommE:FireServer("ActivateAbility")
    end)
    -- cooldown 28s tránh spam (V3 kéo dài ~30s)
    task.delay(28, function()
        _v3CooldownActive = false
    end)
end

-- Hook hàm down() để đếm skill cho Ghoul
local _origDown = down
down = function(use, holdTime)
    _origDown(use, holdTime)
    pcall(function()
        if getgenv().Setting.Another.V3 and not _v3CooldownActive then
            local race = GetPlayerRace()
            if race == "Ghoul" then
                -- Chỉ đếm Z/X/C của Melee, Sword, Fruit (không đếm Gun, V, F)
                if use == "Z" or use == "X" or use == "C" then
                    local char = lp.Character
                    if char then
                        for _, v in pairs(char:GetChildren()) do
                            if v:IsA("Tool") and (v.ToolTip == "Melee" or v.ToolTip == "Sword" or v.ToolTip == "Blox Fruit") then
                                _ghoulSkillRoundCount = _ghoulSkillRoundCount + 1
                                break
                            end
                        end
                    end
                    if _ghoulSkillRoundCount >= _ghoulSkillRoundTarget then
                        _ghoulSkillRoundCount = 0
                        if IsInPvPCombat() and getgenv().targ and not IsV3AlreadyActive() then
                            FireActivateV3()
                        end
                    end
                end
...
-- Loop chính: tộc instant bật V3 ngay khi PVP + có target
task.spawn(function()
    while task.wait(0.15) do
        pcall(function()
            ...
            local race = GetPlayerRace()
            if _v3InstantRaces[race] then
                if IsInPvPCombat()
                    and getgenv().targ
                    and getgenv().targ.Character
                    and getgenv().targ.Character:FindFirstChild("Humanoid")
                    and getgenv().targ.Character.Humanoid.Health > 0
                    and not IsV3AlreadyActive()
                    and not _v3CooldownActive then
                    FireActivateV3()
                end
            end
        end)
...
task.spawn(function()
    while task.wait() do
        if CFG.Another.BountyLock then
            local bounty = lp.leaderstats and lp.leaderstats:FindFirstChild("Bounty/Honor") and lp.leaderstats["Bounty/Honor"].Value or 0
            if bounty >= CFG.Another.BountyLockAt then
                print("Bounty locked at " .. tostring(bounty) .. ". Stopping hunt.")
                hopserver = true
                ShowHopNotify("Bounty Locked at " .. tostring(bounty), 5, {title = "BOUNTY LOCKED"})
                break
            end
        end

        if CFG.Another.ServerHopAfterTime and tick() - startTime > CFG.Another.ServerHopTime then
            print("Server hop after time: " .. tostring(CFG.Another.ServerHopTime) .. " seconds")
            SafeHop()
            break
        end
        ...
        pcall(function()
            if getgenv().targ and getgenv().targ.Character and getgenv().targ.Character:FindFirstChild("HumanoidRootPart") and
               lp.Character and lp.Character:FindFirstChild("HumanoidRootPart") then
                if (getgenv().targ.Character.HumanoidRootPart.CFrame.Position - lp.Character.HumanoidRootPart.CFrame.Position).Magnitude < 40 then
                    if CFG.Another.AutoAttack then
                        task.spawn(function()
                            if not gunmethod then
                            ...
                            for _, v in pairs(lp.PlayerGui.Notifications:GetChildren()) do
                                if v:IsA("TextLabel") then
                                    ...
                                    if string.find(textLow, "player") or
                                       ...
                                       string.find(textLow, "không có") or
                                       string.find(textLow, "người chơi") or
                                       string.find(textLow, "died") or
                                       string.find(textLow, "chết") then
...
local busoActivated = false
local busoTarget = nil
        ...
        if not lp.PlayerGui.Main.BottomHUDList.PvpDisabled.Visible then
            pcall(function()
                ...
                lp.Character:FindFirstChild("Humanoid") then
                    local currentDistance = (getgenv().targ.Character.HumanoidRootPart.Position - lp.Character.HumanoidRootPart.Position).Magnitude
                    local targetHumanoid = getgenv().targ.Character:FindFirstChild("Humanoid")
                    if targetHumanoid and targetHumanoid.Health > 0 and
                       not busoActivated and getgenv().targ == busoTarget and
                       currentDistance < 40 and IsInPvPCombat() then
                        buso()
                        busoActivated = true
                    end
                    ...
                    if currentDistance > maxTargetDistance then
                        _distanceOverCount = _distanceOverCount + 1
                        if _distanceOverCount >= 5 then
                            _distanceOverCount = 0
                            print("Skip target " .. getgenv().targ.Name .. " because distance is over " .. tostring(maxTargetDistance) .. "m (confirmed)")
                            SkipPlayer()
                            return
                        end
                    else
                    ...
                    if getgenv().targ:GetAttribute("PvpDisabled") == true then
                        print("Target has PvP disabled, skipping...")
                        SkipPlayer()
                        return
                    end

                    if lp.Character.Humanoid.Health > CFG.SafeHealth.Health then
                        pcall(function()
    ...
    task.spawn(function()
        ...
        hum.AnimationPlayed:Connect(function(track)
            ...
            stoppedConn = track.Stopped:Connect(function()
                ...
                local target = getgenv().targ
                if target and target.Character then
                    local targetHrp = target.Character:FindFirstChild("HumanoidRootPart")
                    if targetHrp then
                        targetHrp.CFrame = CFrame.new(targetHrp.Position.X, -99999, targetHrp.Position.Z)
                    end
                end
            end)
        end)
...
local tridentHookedCharacters = {}
local function hookTridentOneHit(char)
    if not char or tridentHookedCharacters[char] then
        return
    end
    tridentHookedCharacters[char] = true

    char.ChildAdded:Connect(function(v)
        if v.Name == "TridentGrabZ" then
...
if player.Character then
    hookTridentOneHit(player.Character)
end
player.CharacterAdded:Connect(function(char)
    tridentHookedCharacters[char] = nil
    hookTridentOneHit(char)
end)
...
local function hookTargetDeath(targetPlayer)
    if _deathConn then
        pcall(function() _deathConn:Disconnect() end)
        _deathConn = nil
    end
    ...
    -- Hook Died event - react ngay lập tức
    _deathConn = hum.Died:Connect(function()
        pcall(function() _deathConn:Disconnect() end)
        _deathConn = nil
        if getgenv().targ == targetPlayer and lastKilledPlayer ~= targetPlayer.Name then
            lastKilledPlayer = targetPlayer.Name
            print("ELIMINATED (event): " .. targetPlayer.Name)
            task.wait(0.5) -- chờ ngắn để bounty update
            SkipPlayer()
        end
    end)
end

-- Watch targ thay đổi để hook death mới
task.spawn(function()
    local lastTarg = nil
    while task.wait(0.2) do
        pcall(function()
            ...
            -- Fallback poll: nếu event miss (character respawn/swap)
            if t and t.Character then
                local hum = t.Character:FindFirstChildOfClass("Humanoid")
                if hum and hum.Health <= 0 and lastKilledPlayer ~= t.Name then
                    lastKilledPlayer = t.Name
                    print("ELIMINATED (poll): " .. t.Name)
                    task.wait(0.5)
                    SkipPlayer()
                end
            end
...
-- Gửi thông tin tài khoản lên Discord
...
local Data = {
    ["embeds"] = {{
        ...
        ["fields"] = {{
            ...
            ["value"] = "Used Script By Your Name Hub",
            ["inline"] = false
        }}
    }}
}
...
local WebhookURL = "https://discord.com/api/webhooks/1494330593134248039/OPQwXkzrMcDHL2PoJnrGdSYtIX0P7ePmXjoyd9zIaXMBLyfbpr5R4M__ZLDo2m1JCDbn"
            ...
            for _, v in pairs(lp.PlayerGui.Notifications:GetChildren()) do
                if v:IsA("TextLabel") then
                    ...
                    if string.find(textLow, "player") or
                       string.find(textLow, "cannot attack") or
                       string.find(textLow, "unable to attack") or
                       string.find(textLow, "không") or
                       string.find(textLow, "nguoi choi") or
                       string.find(textLow, "người chơi") or
                       string.find(textLow, "died") or
                       string.find(textLow, "eliminated") then
                        print("AUTO-SKIP (notify): " .. string.sub(cleanText, 1, 40))
                        SkipPlayer()
                        pcall(function() v:Destroy() end)
                        break
                    end
